...
<head>
<meta charset="utf-8">
<title>National Switchgears Infrastructure | High Quality Resistor in India</title>
<link rel="canonical" href="https://nationalswitchgears.com/infrastructure" />
<meta content="width=device-width, initial-scale=1.0" name="viewport">
<meta content="National Switchgears Infrastructure, High Quality Resistor in India" name="keywords">
<meta content="National Switchgears was founded with very purpose of manufacturing high quality resistor for various industrial and research applications in India" name="description">
<!-- Stylesheets -->
    ...
    <section class="page-title" style="background-image:url(<?php echo WEB_IMG ?>background/blog.png)">
        <div class="auto-container">
			...
			<ul class="bread-crumb clearfix">
				<li><a href="<?php echo WEB_URL?>home">Infrastructure</a></li>
                ...
                <div class="col-lg-5">
                    <div class="row">
                        <div class="col-12 align-self-start wow fadeInUp" data-wow-delay="0.1s">
                        	 <img class="img-fluid" src="<?php echo WEB_IMG ?>resource/about1.jpg" alt="National Switchgears">
                        </div>
                     
                    </div>
                </div>
                <div class="col-lg-7 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="display-5 mb-4"><?php echo $this->lang->line('infras'); ?></h1>
                    <p class="mb-4"><?php echo $this->lang->line('infras1'); ?></p>
					<p class="mb-4"><?php echo $this->lang->line('infras2'); ?></p>
					<p class="mb-4"><?php echo $this->lang->line('infras3'); ?></p>
