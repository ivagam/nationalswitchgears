...
<head>
<meta charset="utf-8">
<title>National Switchgears Achievement | National Switchgear Products Certificates</title>
<link rel="canonical" href="https://nationalswitchgears.com/cerficates" />
<meta content="width=device-width, initial-scale=1.0" name="viewport">
<meta content="National Switchgear Products Certification" name="keywords">
<meta content="Explore how National Switchgear products adhere to compliance standards. Delve into the quality assurance processes involved in National Switchgear product certification" name="description">
<!-- Stylesheets -->
                ...
                <div class="col-lg-5">
                    <div class="row">
                        <div class="col-12 align-self-start wow fadeInUp" data-wow-delay="0.1s">
							<a href="<?php echo WEB_IMG ?>certificate/certificate.jpg" class="image-link">
                        	 <img class="img-fluid" src="<?php echo WEB_IMG ?>certificate/01_Certificate_01.jpg" alt="BSI Certificate">
							</a>
                        </div>
