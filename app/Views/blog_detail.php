...
<link rel="canonical" href="https://nationalswitchgears.com/blog_details" />
<!-- Stylesheets -->
...
<div class="page-wrapper">
	...
	<div class="main-slider-three">
		...
		<div class="single-item-carousel owl-carousel owl-theme">
			...
			<!-- Slide -->
			<div class="slide">
				<div class="slider-three_image-layer" style="background-image:url(public/images/main-slider/Slider_02.webp)"></div>
			...
			<!-- Slide -->
			<div class="slide">
				<div class="slider-three_image-layer" style="background-image:url(public/images/main-slider/Slider_01.webp)"></div>
				<div class="slider-three_curve-layer" style="background-image:url(public/images/main-slider/curve.png)"></div>
				<div class="auto-container">
			...
			<!-- Slide -->
			<div class="slide">
				<div class="slider-three_image-layer" style="background-image:url(public/images/main-slider/Slider_03.webp)"></div>
				<div class="slider-three_curve-layer" style="background-image:url(public/images/main-slider/curve.png)"></div>
				<div class="auto-container">
			...
			<div class="row clearfix">
				...
				<div class="service-block_five col-lg-3 col-md-6 col-sm-12">
					<div class="service-block_five-inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="service-block_five_icon"><img src="public/images/icons/service-18.png" alt="icons" /></div>
						<h5 class="service-block_five_heading"><a href="service-detail.html">Neutral Grounding Resistor</a></h5>
						<div class="service-block_five-text">NGR/NER is used to ground the neutral of Transformer.</div>
				...
				<div class="service-block_five col-lg-3 col-md-6 col-sm-12">
					<div class="service-block_five-inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="service-block_five-color-layer"></div>
						<div class="service-block_five_pattern" style="background-image:url(public/images/background/pattern-38.png)"></div>
						<div class="service-block_five_icon"><img src="public/images/icons/service-19.png" alt="icons" /></div>
						<h5 class="service-block_five_heading"><a href="service-detail.html">Harmonic Filter Resistor</a></h5>
						<div class="service-block_five-text">Ever increasing usage of solid state devices.</div>
						<a href="service-detail.html" class="theme-btn service-block_five-more">Read more</a>
					</div>
				</div>
				...
				<div class="service-block_five col-lg-3 col-md-6 col-sm-12">
					<div class="service-block_five-inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="service-block_five-color-layer"></div>
						<div class="service-block_five_pattern" style="background-image:url(public/images/background/pattern-38.png)"></div>
						<div class="service-block_five_icon"><img src="public/images/icons/service-20.png" alt="icons" /></div>
						<h5 class="service-block_five_heading"><a href="service-detail.html">Dynamic Breaking Resistor</a></h5>
						<div class="service-block_five-text">The applications are innumerable like starting	.</div>
						<a href="service-detail.html" class="theme-btn service-block_five-more">Read more</a>
					</div>
				</div>
				...
				<div class="service-block_five col-lg-3 col-md-6 col-sm-12">
					<div class="service-block_five-inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="service-block_five-color-layer"></div>
						<div class="service-block_five_pattern" style="background-image:url(public/images/background/pattern-38.png)"></div>
						<div class="service-block_five_icon"><img src="public/images/icons/service-21.png" alt="icons" /></div>
						<h5 class="service-block_five_heading"><a href="service-detail.html">Switch Disconnector</a></h5>
						<div class="service-block_five-text">They are used in distribution net works for easy Isolation.</div>
						<a href="service-detail.html" class="theme-btn service-block_five-more">Read more</a>
					</div>
				</div>
			...
			<div class="row clearfix">
				...
				<div class="about-two_image-column col-lg-6 col-md-12 col-sm-12">
					...
					<div class="about-two_image">
						<img src="<?php echo WEB_IMG ?>resource/about-2.webp" alt="web" />
						<!-- About One Detail -->
						...
						<div class="about-two_feature">
							<div class="row clearfix">
								...
								<div class="about-two_block col-lg-6 col-md-6 col-sm-6">
									<div class="about-two_block-inner">
										<span class="about-two_block-icon">
											<img src="<?php echo WEB_IMG ?>icons/about-1.png" alt="icons" />
										</span>
								...
								<div class="about-two_block col-lg-6 col-md-6 col-sm-6">
									<div class="about-two_block-inner">
										<span class="about-two_block-icon">
											<img src="<?php echo WEB_IMG?>icons/about-2.png" alt="icons" />
										</span>
			...
			<div class="cta-two_inner-container" style="background-image: url(images/background/map.png)">
				<div class="d-flex justify-content-between align-items-center flex-wrap">
					<div class="cta-two_author">
						<span class="cta-two_author-image"><img src="public/images/resource/testmonail1.jpg" alt="" /></span>
						Gal Gadot
						<i>Support Person</i>
					</div>
					...
					<div class="cta-two_button-box">
						<a class="btn-style-seven theme-btn" href="<?php echo WEB_URL?>contact-us">
							<div class="btn-wrap">
		...
		<div class="auto-container">
			...
			<div class="inner-container">
				<div class="row clearfix">
						...
						<div class="service-block_six-inner">
							<div class="service-block_six-content">
								<span class="service-block_six-icon">
									<img src="public/images/icons/service-25.gif" alt="icons" /> 
								</span>
								<h4 class="service-block_six-heading"><a href="#">Neutral Grounding resistor</a></h4>
								<div class="service-block_six-text">NGR / NER is used to ground the neutral of Transformer / Generator to limit prospective ground.</div>
					...
					<div class="service-block_six col-lg-4 col-md-6 col-sm-12">
						<div class="service-block_six-inner">
							<div class="service-block_six-content">
								<span class="service-block_six-icon">
									<img src="public/images/icons/service-26.gif" alt="icons" />
								</span>
								<h4 class="service-block_six-heading"><a href="#">Load Bank</a></h4>
								<div class="service-block_six-text">Load Bank is used to test and evaluate performance of Generators and UPS periodically.</div>
								<a class="service-block_six-more theme-btn" href="#">Discover more</a>
							</div>
						</div>
					</div>
					...
					<div class="service-block_six col-lg-4 col-md-6 col-sm-12">
						<div class="service-block_six-inner">
							<div class="service-block_six-content">
								<span class="service-block_six-icon">
									<img src="public/images/icons/service-27.gif" alt="icons" />
								</span>
								<h4 class="service-block_six-heading"><a href="#">Harmonic Filter Resistor</a></h4>
								<div class="service-block_six-text">Ever increasing usage of solid state devices like VFD drives and Thyristor controlled Electrical.</div>
								<a class="service-block_six-more theme-btn" href="#">Discover more</a>
							</div>
						</div>
					</div>
					...
					<div class="service-block_six col-lg-4 col-md-6 col-sm-12">
						<div class="service-block_six-inner">
							<div class="service-block_six-content">
								<span class="service-block_six-icon">
									<img src="public/images/icons/service-28.gif" alt="icons" />
								</span>
								<h4 class="service-block_six-heading"><a href="#">Switch Disconnector</a></h4>
								<div class="service-block_six-text">They are used in distribution net works for easy Isolation, RMU, Neutral.</div>
								<a class="service-block_six-more theme-btn" href="#">Discover more</a>
							</div>
						</div>
					</div>
					...
					<div class="service-block_six col-lg-4 col-md-6 col-sm-12">
						<div class="service-block_six-inner">
							<div class="service-block_six-content">
								<span class="service-block_six-icon">
									<img src="public/images/icons/service-29.gif" alt="icons" />
								</span>
								<h4 class="service-block_six-heading"><a href="#">Dynamic breaking resistor</a></h4>
								<div class="service-block_six-text">The applications are innumerable like starting of slip ring Induction motor.</div>
								<a class="service-block_six-more theme-btn" href="#">Discover more</a>
							</div>
						</div>
					</div>
				...
				<div class="services-four_button-box text-center">
					<a class="btn-style-seven theme-btn" href="<?php echo WEB_URL?>product">
						<div class="btn-wrap">
							<span class="text-one">get started</span>
							<span class="text-two">get started</span>
						</div>
						...
						<div class="row clearfix">
							...
							<div class="contact-one_info col-lg-6 col-md-6 col-sm-6">
								<div class="contact-one_info-outer">
									...
									Our Locations
									<strong> Ambattur, Chennai 600 098, India</strong>
								</div>
							</div>
							...
							<div class="contact-one_info col-lg-6 col-md-6 col-sm-6">
								<div class="contact-one_info-outer">
									...
									Our Mail Address
									<strong>sales@nationalswitch<br>gears.com</strong>
								</div>
							</div>
						...
						<div class="single-item-carousel owl-carousel owl-theme">
							...
							<div class="testimonial-block_two">
								<div class="testimonial-block_two-inner">
									<span class="testimonial-block_two-quote"><img src="public/images/icons/quote.png" alt="quote" /></span>
									<div class="testimonial-block_two-author">
										<img src="public/images/resource/test.jpg" alt="" />
									</div>
									<div class="testimonial-block_two-text">Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed sed. Magna
                        ut diam sit et amet stet eos sed clita erat magna elitr erat sit sit erat at rebum justo sea
                        clita..</div>
									<div class="testimonial-block_two-author-name">Gal Gadot</div>
							...
							<div class="testimonial-block_two">
								<div class="testimonial-block_two-inner">
									<span class="testimonial-block_two-quote"><img src="public/images/icons/quote.png" alt="quote" /></span>
									<div class="testimonial-block_two-author">
										<img src="public/images/clients/client1.jpg" alt="" />
									</div>
									<div class="testimonial-block_two-text">Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed sed. Magna
                        ut diam sit et amet stet eos sed clita erat magna elitr erat sit sit erat at rebum justo sea
                        clita.</div>
									<div class="testimonial-block_two-author-name"> Smith</div>
									<div class="testimonial-block_two-designation">Senior Developer</div>
								</div>
							</div>
							...
							<div class="testimonial-block_two">
								<div class="testimonial-block_two-inner">
									<span class="testimonial-block_two-quote"><img src="public/images/icons/quote.png" alt="quote" /></span>
									<div class="testimonial-block_two-author">
										<img src="public/images/clients/client2.jpg" alt="" />
									</div>
									<div class="testimonial-block_two-text">Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed sed. Magna
                        ut diam sit et amet stet eos sed clita erat magna elitr erat sit sit erat at rebum justo sea
                        clita.</div>
									<div class="testimonial-block_two-author-name">Steve</div>
									<div class="testimonial-block_two-designation">Senior Developer</div>
								</div>
							</div>
